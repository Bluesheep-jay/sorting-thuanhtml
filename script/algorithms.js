      ...
      for (let j = 0; j < elements.length - 1; ++j) {
        ...
        if (
          order == "desc"
            ...
            : elements[j] > elements[j + 1] // trước > sau thì swap
        ) {
          swapped = true;
...
//         left < n &&
//         (order == "asc"
//           ? elements[left] > elements[current]
//           : elements[left] < elements[current])
//       ) {
//         current = left;
//       }
...
//         right < n &&
//         (order == "asc"
//           ? elements[right] > elements[current]
//           : elements[right] < elements[current])
//       ) {
//         current = right;
//       }
